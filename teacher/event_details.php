              ...
              <div class="team-info">
                ...
                <ul class="social_section_1info mt-md-4 mt-3">
                  <table class="table">
                    ...
                    <tr>
                            <form action="registrations.php?e_id=<?php echo $e_id; ?>" method="post">
                                <button type='submit' name='register_event_button' class='btn btn-primary submit mb-4'>Check Registrations</button>
                            </form>
                    </tr>
                  </table>
                </ul>
