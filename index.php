...
<body>
  ...
  <div class="banner-content" id="home">
    ...
    <div class="banner-info-w3pvt">
      ...
      <p class="my-4">The main purpose of this project is to simplify the process
of displaying each event by providing a web interface for
admin and students.</p>
    ...
    <div class="container py-xl-5 py-lg-3">
      <div class="row banner-grids">
        ...
        <div class="col-md-6 last-img pl-lg-5 p-3">
          <h3 class="tittle my-lg-5 my-3"><span class="sub-tittle"> Now You can </span>Enroll without Paperwork</h3>
          <p class="mb-4">Online College Event Management System manages
all the events which are conducted in college/University in a
systematic way. This system stores data very efficiently,
maintain and retrieve data from its database and can be used
for further analysis. This system provides latest notification to
its user and registers them through online form facilities, Thus
it is a time saving activity.
</p>
          <p class="mb-4">By using Online College Event Management System various
          users can login and view different events and notices updated
          by the college or university. Emergency messages or notice will
          be displayed in the main page of the website. It eases
          registration process so it’s a user friendly website.</p>
          <div class="ban-buttons">
    ...
    <div class="container">
      <div class="row py-lg-5">
        <div class="col-lg-7 apply-info px-lg-5">
          <h3 class="tittle text-white mb-lg-5 mb-3"><span class="sub-tittle">Login to Enroll Right Now!.</span> You need to login to Enroll for events. </h3>
          ...
          <div class="col-lg-4 col-md-12 mt-lg-0 mt-4 col-sm-12 footer-grid_section_1its">
            ...
            <div class="footer-text">
              ...
              <form action="subscribers.php" method="post">
                ...
                <button name="subscribe_btn" type="submit" class="btn1 btn"><span class="fa fa-paper-plane-o" aria-hidden="true"></span></button>
