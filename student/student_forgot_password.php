              ...
              <div class="col-lg-5">
                <form method="post">
                  ...
                  <div class="form-group">
                    <select class="form-control" name="student_select_question">
                  ...
                  <div class="form-group">
                    <input class="form-control" type="text" name="student_enter_answer" placeholder="enter the answer" required>
                  </div>
                  ...
                  <button type="submit" name="get_password_button_s" class="btn btn-primary submit mb-4">Reset</button>
...
<?php
    ...
    if (isset($_POST['get_password_button_s'])) {

      $question=$_POST['student_select_question'];
      $answer=$_POST['student_enter_answer'];
      ...
      if(empty($question) || empty($answer) || empty($new_p) || empty($new_c_p)){
        header("Location: student_forgot_password.php?message=Reset_FAILED");
        exit();
      ...
      $hash_password=password_hash($new_p,PASSWORD_DEFAULT);
        ...
        $sql="UPDATE student_table SET password='$new_p' WHERE security_question='$question' and security_answer='$answer' and srn='$srn'";
