  ...
  <div class="">
    ...
    <section class="ab-info-main py-md-5 py-4">
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">Remove</span>Student here</h3>
              ...
              <div class="col-lg-5">
                <form method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="delete_student_id" placeholder="Enter Student SRN" required>
                  </div>


                  <button type="submit" name="delete_student_button" class="btn btn-primary submit mb-4">Remove</button>
...
if (isset($_POST['delete_student_button']) || isset($_POST['delete_student_id)'])) {
    $student_id=strtolower($_POST['delete_student_id']);
    $pass= password_hash("illegalProfile",PASSWORD_DEFAULT);

    $delete_sql=mysqli_query($conn, "UPDATE student_table SET password='$pass' WHERE srn='$student_id'") or die(mysqli_error($conn));
