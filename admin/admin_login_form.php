        ...
        <?php if(!strlen(@$_GET['message'])=="")
            {
              ...
              <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#"><?php echo $_GET['message'] ;?></a></li>
              </ol>
          <?php
        }
        ?>
                  ...
                  <div class="col-lg-5">
                    <form action="admin_login.php" method="post">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="admin_name" placeholder="enter id" required>
                      </div>
                      ...
                      <button type="submit" name="admin_login_button" class="btn btn-primary submit mb-4">Login</button>
