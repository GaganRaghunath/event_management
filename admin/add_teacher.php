...
||  empty($t_mobno) || empty($t_security_question) || empty($t_security_answer) || empty($t_dob)) {
    ...
    if ($result_check > 0) {
        ...
        $query = "INSERT INTO professor (teacher_id, teacher_name, department_id, teacher_email, teacher_password, designation, teacher_mobno, security_question, security_answer, teacher_dob) VALUES('$t_id', '$t_name', '$t_department', '$t_email', '$hash_password', '$t_designation', '$t_mobno', '$t_security_question', '$t_security_answer', '$t_dob')";
