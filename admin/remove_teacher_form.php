  ...
  <div class="">
    ...
    <section class="ab-info-main py-md-5 py-4">
        <div class="container py-md-5 py-4">
            <h3 class="tittle text-center mb-lg-5 mb-3"><span class="sub-tittle">Remove</span>Teacher here</h3>
              ...
              <div class="col-lg-5">
                <form method="post">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="delete_teacher_id" placeholder="Enter Teacher ID" required>
                  </div>


                  <button type="submit" name="delete_teacher_button" class="btn btn-primary submit mb-4">Remove</button>
...
if (isset($_POST['delete_teacher_button'])||isset($_POST['delete_teacher_id)'])) {
    $teacher_id=$_POST['delete_teacher_id'];
    $pass= password_hash("illegalProfile",PASSWORD_DEFAULT);

    $delete_sql=mysqli_query($conn, "UPDATE professor SET teacher_password='$pass' WHERE teacher_id='$teacher_id'") or die(mysql_error());
